    ...
    <footer class="w-full bg-gris">
        <div class="flex flex-col sm:flex-row w-2/3 sm:w-2/3 p-5 pt-8 mx-auto me-auto h-full text-white gap-2">
            ...
            <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-4 sm:mb-0">
                ...
                <!--Social buttons-->
                <button type="button" class="text-white w-3/4 sm:w-2/3 bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-1">
                ...
                <!--Twitter-->
                <button type="button" class="text-white w-3/4 sm:w-2/3 bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-1">
                ...
                <!--Google-->
                <button type="button" class="text-white w-3/4 sm:w-2/3 bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-1">
                ...
                <!--WhatsApp-->
                <button type="button" class="text-white w-3/4 sm:w-2/3 bg-[#25D366] hover:bg-[#25D366]/90 focus:ring-4 focus:outline-none focus:ring-[#25D366]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#25D366]/55 me-2 mb-1">
