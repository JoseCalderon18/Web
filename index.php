...
<body>
    <header>
        <nav class="fixed top-0 left-0 right-0 z-50 flex flex-wrap justify-between items-center p-4 w-full h-32 bg-logo" aria-label="Navegación principal">
            <img src="assets/img/logo.png" alt="Logotipo de BioSpace - Centro de bienestar natural" class="h-24 md:h-26 lg:h-28">
            ...
            <!-- Menú de navegación -->
            <ul id="menuNav" class="hidden sm:flex w-full sm:w-auto flex-col sm:flex-row items-start sm:items-center gap-4 lg:gap-6 xl:gap-8 bg-white sm:bg-transparent p-4 sm:p-0 text-[6px] sm:text-[8px] md:text-[10px] lg:text-xs font-display-Lora uppercase font-semibold mt-4 sm:mt-0 absolute sm:relative left-0 top-full sm:top-auto" aria-label="Lista de navegación principal">
                <li class="w-full sm:w-auto"><a href="#" class="block py-2 sm:py-0 text-black hover:text-gray-600 hover:underline pl-4 sm:pl-0" aria-label="Ir a sección Nosotras">Nosotras</a></li>
                <li class="w-full sm:w-auto"><a href="#" class="block py-2 sm:py-0 text-black hover:text-gray-600 hover:underline pl-4 sm:pl-0" aria-label="Ir a sección El Herbolario">El Herbolario</a></li>
                <li class="w-full sm:w-auto"><a href="#" class="block py-2 sm:py-0 text-black hover:text-gray-600 hover:underline pl-4 sm:pl-0" aria-label="Ir a sección Terapias">Terapias</a></li>
                <li class="w-full sm:w-auto"><a href="#" class="block py-2 sm:py-0 text-black hover:text-gray-600 hover:underline pl-4 sm:pl-0" aria-label="Ir a sección Equipo">Equipo</a></li>
                <li class="w-full sm:w-auto"><a href="#" class="block py-2 sm:py-0 text-black hover:text-gray-600 hover:underline pl-4 sm:pl-0" aria-label="Ir a sección Encuentranos">Encuentranos</a></li>
            </ul>
        </nav>
    ...
    <main>
    <div class="bg-gray-700 w-full h-5" aria-label="Separador decorativo"></div>
    ...
    <footer class="w-full bg-gris">
        <div class="flex flex-row w-3/4 p-8 pt-16 mx-auto h-100 text-white">
            <!--Primer bloque-->
            <div class="flex flex-col gap-2 w-1/3 px-4">
            ...
            <div class="flex flex-col gap-2 w-1/3 px-4">
                ...
                <p>━━━━━━━</p>
                <p class="text-xs mb-3">Síguenos en nuestras redes sociales para estar al día de todas nuestras novedades y eventos.</p>
                <!--Facebook-->
                <button type="button" class="text-white w-2/3 bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
                ...
                <!--Twitter-->
                <button type="button" class="text-white w-2/3 bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
                ...
                <!--Google-->
                <button type="button" class="text-white w-2/3 bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
                ...
                <!--WhatsApp-->
                <button type="button" class="text-white w-2/3 bg-[#25D366] hover:bg-[#25D366]/90 focus:ring-4 focus:outline-none focus:ring-[#25D366]/50 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#25D366]/55 me-2 mb-2">
        ...
        <!--Copyright-->
        <div class="w-full bg-neutral-700 text-center text-sm text-gray-500 py-6">
            <p>Copyright © 2025</p>
        </div>
    </footer>
    ...
    <script src="node_modules/flowbite/dist/flowbite.min.js" alt="Script de Flowbite"></script>
</body>
</html>