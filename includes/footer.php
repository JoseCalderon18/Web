    ...
    <div class="flex flex-col sm:flex-row w-2/3 sm:w-2/3 p-5 pt-8 mx-auto me-auto h-full text-white gap-2">
        ...
        <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-4 sm:mb-0">
            ...
            <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-2 md:m-4 sm:mb-0">
                ...
                <!--WhatsApp-->
                <a href="https://wa.me/+34916666666" target="_blank" class="text-white h-10 w-full sm:w-3/4 bg-[#25D366] hover:bg-green-800 hover:scale-105 transition-all duration-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 mb-2 cursor-pointer">
