    ...
    <div class="flex flex-col sm:flex-row w-2/3 sm:w-2/3 p-5 pt-8 mx-auto me-auto h-full text-white gap-2">
        ...
        <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-4 sm:mb-0">
            ...
            <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-4 sm:mb-0">
                ...
                <p class="text-xs">11:00 - 14:00 y 17:30 - 20:30</p>
            ...
            <div class="flex flex-col gap-3 w-full sm:w-1/3 p-4 m-4 sm:mb-0">
                ...
                <!--WhatsApp-->
                <a href="https://wa.me/+34640381556" target="_blank" class="text-white h-10 w-full sm:w-3/4 bg-[#25D366] hover:bg-green-800 hover:scale-105 transition-all duration-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 mb-2 cursor-pointer">
                ...
                <!--Instagram-->
                <a href="https://www.instagram.com/BioespacioBienestar" target="_blank" style="background: linear-gradient(45deg, #833AB4, #C13584, #E1306C, #FD1D1D); color: white;" class="h-10 w-full sm:w-3/4  hover:scale-105 transition-all duration-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 mb-2">
                    <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!--YouTube-->
                <a href="https://www.youtube.com" target="_blank" class="bg-red-600 hover:bg-red-800 h-10 w-full sm:w-3/4 hover:scale-105 transition-all duration-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 mb-2">
                    <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
