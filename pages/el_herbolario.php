    ...
    <main>
        ...
        <div class="bg-beige">
            <div class="pt-4 py-6 flex flex-col sm:flex-row justify-center items-center h-full w-3/4 mx-auto text-gray-900">
                <div class="flex flex-col w-full sm:w-1/2 text-center">
                    ...
                    <p class=" text-base">consectetur adipisicing elit. Quisquam, quos.</p>
                </div>
                <div class="w-full sm:w-2/3 flex justify-center mt-6 sm:mt-0">
                    <img src="../assets/img/el_herbolario/foto2.png" alt="El Herbolario" class="object-contain w-3/4 sm:w-1/2">
                </div>
            </div>
        </div>
        <!-- Segundo div -->
        <div>
            ...
            <div class="bg-gray-200 py-24 w-full">
                <div class="flex flex-col sm:flex-row items-center w-3/4 mx-auto">
                    <!-- En móvil: foto primero, en desktop: layout original -->
                    <div class="w-full sm:w-1/3 mb-6 sm:mb-0 order-1 sm:order-none">
                        <img src="../assets/img/el_herbolario/foto3.jpg" alt="Productos naturales" class="object-cover rounded-lg  w-full">
                    </div>
            ...
            <div class="bg-white border-y border-gray-200 py-24 w-full text-verde">
                <div class="flex flex-col-reverse sm:flex-row items-center w-3/4 mx-auto">
                    ...
                    <div class="w-full sm:w-1/3 mb-6 sm:mb-0 order-1 sm:order-none">
                        <img src="../assets/img/el_herbolario/puerta.jpeg" alt="Puerta de Bioespacio" class="object-cover rounded-lg w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-200 py-24 w-full">
                <div class="flex flex-col items-center justify-center w-3/4 mx-auto">
                    <p class="mb-3 text-center">Nuestra disponibilidad en tienda es limitada. Los horarios para recoger los productos son:</p>
